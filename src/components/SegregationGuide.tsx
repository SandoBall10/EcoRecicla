...
export function SegregationGuide({ onNavigate }: SegregationGuideProps) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50 pb-24">
      {/* Header */}
      <div className="bg-gradient-to-r from-green-500 to-emerald-600 text-white p-4 sticky top-0 z-10 shadow-lg">
      ...
      <div className="max-w-4xl mx-auto p-4 space-y-6">
        ...
        >
          <Card className="p-6 bg-white shadow-lg border-2 border-green-200">
            <div className="flex items-start gap-4">
              <div className="w-16 h-16 bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl flex items-center justify-center flex-shrink-0 text-3xl">
                💚
              </div>
              <div className="flex-1">
        ...
        >
          <Card className="p-8 bg-gradient-to-r from-green-500 to-emerald-600 text-white shadow-xl">
            <div className="max-w-2xl mx-auto space-y-4">
              ...
              {onNavigate && (
                <Button
                  onClick={() => onNavigate("home")}
                  size="lg"
                  className="bg-white text-green-600 hover:bg-green-50 mt-4"
                >
                  Volver al inicio
                </Button>
              )}
